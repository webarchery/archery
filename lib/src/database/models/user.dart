...
final class User extends Model with InstanceDatabaseOps<User> {
  ...
  Map<String, dynamic> toJson() {
    return {"uuid": uuid, 'name': name, 'email': email, 'created_at': createdAt?.toIso8601String(), 'updated_at': updatedAt?.toIso8601String()};
  }

  @override
  Map<String, dynamic> toMetaJson() {
    return {"id": id, "uuid": uuid, 'name': name, 'email': email, "password": password, 'created_at': createdAt?.toIso8601String(), 'updated_at': updatedAt?.toIso8601String()};
  }
