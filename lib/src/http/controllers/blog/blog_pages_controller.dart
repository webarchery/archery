...
final List<Map<String, dynamic>> blogPostsSeed = [
  {
    ...
    "excerpt":
        "An introduction to the Archery framework — pragmatic, fast, and built with Dart.",
    "content": """
...
In this post, we’ll explore the philosophy behind Archery, its design principles, and what makes it different from other frameworks.
    ...
    "author": "King Archer",
    "category": "Framework",
    "published_at": DateFormat(
      'EEEE, MMMM d, yyyy',
    ).format(DateTime(2025, 10, 1)),
  ...
  },
  {
    ...
    "excerpt":
        "A look at Archery’s Service Container and how it brings clean dependency management to your Dart apps.",
    "content": """
...
With features like factories, singletons, and scoped containers, you can achieve Laravel-like elegance in Dart.
  ...
  },
  {
    ...
    "excerpt":
        "Learn how Archery’s Router handles dynamic routes, middleware, and controllers efficiently.",
    "content": """
...
You can define routes declaratively, and soon, even use typed dynamic parameters for type-safe request handling.
  ...
  },
  {
    ...
    "excerpt":
        "Middleware provides a way to wrap requests in logic before they reach the route handler.",
    "content": """
...
class BlogPagesController {
  static Future<HttpResponse> index(HttpRequest request) async {
    return request.view("blog.index", {'posts': blogPostsSeed});
  }

  static Future<HttpResponse> show<T>(HttpRequest request) async {
